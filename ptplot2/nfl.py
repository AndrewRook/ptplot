...
class Field(Layer):
    ...
    def __radd__(self, ptplot: PTPlot):
        ...
        ptplot.figure.image_rgba(image=[img], x=self.min_yardline, y=y_min, dw=x_yards, dh=y_yards)

        # Have to manually set the width here because I can't figure out how to make bokeh scale
        # to it automatically :(
        ptplot.figure.width = int(round(ptplot.figure.height * x_yards / y_yards))
